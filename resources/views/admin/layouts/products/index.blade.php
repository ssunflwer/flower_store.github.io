	...
	<table class="table table_xk table-hover table-bordered">
		<thead class="thead_green">
			<tr>
				...
				<th class="text-center" style="width: 6%">Hình ảnh</th>
				<th class="text-center" style="width: 10%">Giá</th>
				<th class="text-center" style="width: 10%">Giá sale</th>
				<th class="text-center" style="width: 4%">Số lượng</th>
				<!-- <th class="text-center" style="width: 1%">Hot</th> -->
				<th class="text-center" style="width: 1%">New</th>
